...
public class ProjectOverview
{
	...
	private boolean validateEntityStructure()
	{
			...
			for (PropertyType property : entity.getProperty())
			{
				...
				switch (property.getType().toLowerCase())
				{
					...
					case "datetime":
						break;
					default:
						if (!checkComplexProperty(property.getType()))
						{
	...
	private boolean checkComplexProperty(String type)
	{
		for (EntityType entity : entities.getEntity())
		{
