...
public class CreateNewEntity
{
	...
	public CreateNewEntity(final JFrame frame, final EntitiesType entities)
	{
		...
		createEntityButton.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseClicked(MouseEvent e)
			{
				...
				// if the entity is valid, create new entity and load overview page for created entity
				if (createNewEntity())
				{
		...
		// cancel the creation of a new entity and return to the project overview
	...
	/**
	 * Load the createNewEntity panel
	 */
	...
	/**
	 * Try to create a new entity if given entity name is valid
	 *
	 * @return true if entity has been created, false otherwise
	 */
